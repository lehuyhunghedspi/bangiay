...
<?php 
$sql="SELECT Gia, MoTa, TenSP, UrlHinh, bonho_ram, bonho_bo_nho_trong FROM sanpham, sanpham_thuoctinh WHERE sanpham_thuoctinh.idSP=sanpham.idSP AND idLoai=$idLoai";
if(!empty($ram)) {
	   							 ...
	   							 <div class="card card-product card-plain no-shadow" data-colored-shadow="false">
	   								 <div class="card-image">
	   									 <a href="ecommerce.html#">
	   										 <img src="<?php echo "https://begin-ngoctran1910.c9users.io/examples/hinhchinh/".$row["UrlHinh"]; ?>" />
	   									 </a>
	   								 </div>
	   								 <div class="card-content">
	   									 <a href="ecommerce.html#">
